...
export default class ReactInput {
	static get toolbox() {
		return {
			title: "React Input",
	...
	render() {
		...
		const element = renderHTML(
			`<fieldset class="my-2 pr-2">
				<label>
					<input class="w-full border-none p-0 text-sm leading-none mb-0.5 outline-none" placeholder="Label" data-setting="label">
					<input class="w-full border border-current px-1 py-0.5 m-0 leading-none" placeholder="Placeholder text" data-setting="placeholder">
				</label>
				<details>
